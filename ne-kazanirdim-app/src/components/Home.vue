    ...
    <div class="main">
      <div class="main-calculate">
        ...
        <div class="form-group row m-0">
          <label for="example-date-input" class="col-12 col-form-label calculate-label">
            Investment Date
          </label>
          <div class="col-8">
            <input
        ...
        <div class="form-group row m-0">
          ...
          <div class="col-8">
            <input type="number" placeholder="Number" v-model="money" class="col-10 calculate-input" />
        ...
        <button class="form-group btn btn-primary calculate-button" @click="calc()">
          Calculate
        </button>
        ...
        <div v-if="investment_target_currency_value != 0" class="calculate-result">
          <div class="calculate-result-block">
            <span class="calculate-result-block-title">Yatırdığınız Para: </span>
            <span class="calculate-result-block-content"><strong>{{ this.money }}</strong> {{ currency }}</span>
          </div>

          <div class="calculate-result-block">
            <span class="calculate-result-block-title">Yatırdığınız Paranın {{ investment_date }} Tarihindeki Karşılığı:</span>
            <span class="calculate-result-block-content">{{ investment_target_currency_value }} {{ second_currency }}</span>
          </div>

          <div class="calculate-result-block">
            <span class="calculate-result-block-title">Yatırdığınız Paranın {{ date }} Tarihindeki Karşılığı:</span>
            <span class="calculate-result-block-content"><strong> {{ now_target_currency_value }} </strong> {{ second_currency }}</span>
          </div>          
        </div>
